module MasterMayI::ControllerExtensions
  ...
  # {MasterMayI::ControllerExtensions::InstanceMethods#deny_access deny_acces}
  # helper to set the flash, save the intended location, and redirect the user.
  #
  # @see MasterMayI::ControllerExtensions::Filters#ensure_can_create_record
  # @see MasterMayI::ControllerExtensions::Filters#ensure_can_show_record
  # @see MasterMayI::ControllerExtensions::Filters#ensure_can_edit_record
  # @see MasterMayI::ControllerExtensions::Filters#ensure_can_destroy_record
  ...
  # Helper methods added to your controller, which are required by protects_restful_actions
