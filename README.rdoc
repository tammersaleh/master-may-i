...
If these docs looks all wanky, then be sure you're viewing them on the rdoc.info site: 

http://rdoc.info/projects/tsaleh/master-may-i
...
MasterMayI also includes the {MasterMayI::ControllerExtensions#protects_restful_actions +protects_restful_actions+} controller class method, which integrates with InheritedResources in order to automatically check with the model in a set of before filters.
