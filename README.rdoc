...
Master May I comes with a strong set of Shoulda macros for both your {ActiveSupport::TestCase unit tests} and your {ActionController::TestCase functional tests}.  
...
It relies heavily on Authlogic, and uses the +resource+ and +resource_class+ methods from InheritedResources.  The before filters expect there to be the following named route:
